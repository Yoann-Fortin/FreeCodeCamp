...
describe("convertMarkdown", () => {
	...
	it("should convert '# title 1' to '<h1>title 1</h1>'", () => {
		(window.document.querySelector("#markdown-input") as HTMLTextAreaElement).value = "# title 1";
		expect(window.convertMarkdown()).toBe("<h1>title 1</h1>");
	});

	it("should display '<h1>title 1</h1>' inside #html-output when input is '# title 1'", () => {
		const input = window.document.querySelector("#markdown-input") as HTMLTextAreaElement;
		input.value = "# title 1";
	...
	it("should not convert '# title 1' when preceded by other text", () => {
		(window.document.querySelector("#markdown-input") as HTMLTextAreaElement).value = "some text # title 1";
	...
	it("should convert '## title 2' to '<h2>title 2</h2>'", () => {
		(window.document.querySelector("#markdown-input") as HTMLTextAreaElement).value = "## title 2";
	...
	it("should not convert '## title 2' when preceded by other text", () => {
		(window.document.querySelector("#markdown-input") as HTMLTextAreaElement).value = "some text ## title 2";
	...
	it("should convert '### title 3' to '<h3>title 3</h3>'", () => {
		(window.document.querySelector("#markdown-input") as HTMLTextAreaElement).value = "### title 3";
	...
	it("should not convert '### title 3' when preceded by other text", () => {
		(window.document.querySelector("#markdown-input") as HTMLTextAreaElement).value = "some text ### title 3";
	...
	it("should convert '**this is bold**' to '<strong>this is bold</strong>'", () => {
		(window.document.querySelector("#markdown-input") as HTMLTextAreaElement).value = "**this is bold**";
	...
	it("should convert multiple __bold__ on separate lines", () => {
		(window.document.querySelector("#markdown-input") as HTMLTextAreaElement).value = "__this is bold__\n__this is also bold__";
		expect(window.convertMarkdown()).toBe("<strong>this is bold</strong><strong>this is also bold</strong>");
	});

	it("should convert '*this is italic*' to '<em>this is italic</em>'", () => {
		(window.document.querySelector("#markdown-input") as HTMLTextAreaElement).value = "*this is italic*";
	...
	it("should convert '_this is italic_' to '<em>this is italic</em>'", () => {
		(window.document.querySelector("#markdown-input") as HTMLTextAreaElement).value = "_this is italic_";
		expect(window.convertMarkdown()).toBe("<em>this is italic</em>");
	});
	...
	it("should convert '![alt-text](image-source)' to '<img alt=\"alt-text\" src=\"image-source\">'", () => {
		(window.document.querySelector("#markdown-input") as HTMLTextAreaElement).value = "![alt-text](image-source)";
	...
	it("should convert '[link text](URL)' to '<a href=\"URL\">link text</a>'", () => {
		(window.document.querySelector("#markdown-input") as HTMLTextAreaElement).value = "[link text](URL)";
	...
	it("should convert '> this is a quote' to '<blockquote>this is a quote</blockquote>'", () => {
		(window.document.querySelector("#markdown-input") as HTMLTextAreaElement).value = "> this is a quote";
	...
	it("should not convert '>' when preceded by other text", () => {
		(window.document.querySelector("#markdown-input") as HTMLTextAreaElement).value = "some text > not a quote anymore";
